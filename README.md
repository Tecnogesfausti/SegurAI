...
Este repositorio ya incluye un primer add-on en `segurai-addon/` para instalarlo como repositorio personalizado de Home Assistant.

En Home Assistant:

1. Ve a Ajustes -> Complementos -> Tienda de complementos.
2. Abre el menú de los tres puntos y entra en Repositorios.
3. Añade: `https://github.com/Tecnogesfausti/SegurAI`
4. Instala el add-on `SegurAI`.
